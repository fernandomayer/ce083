...
#' # Exercícios
#' 
#' 1. Calcule as 50 primeiras potências de 2, ou seja, $2, 2^2, 2^3,
#'    \ldots, 2^{50}$.
#'     a. Calcule o quadrados dos números inteiros de 1 a 50, ou seja, $1^2,
#'     2^2, 3^2, \ldots, 50^2$.
...
#' 2. Calcule o seno, coseno e a tangente para os números variando de $0$ a
#'    $2\pi$, com distância de $0.1$ entre eles. (Use as funções `sin()`,
#'    `cos()`, `tan()`).
#'     a. Calcule a tangente usando a relação $\tan(x) = \sin(x)/\cos(x)$.
#'     b. Calcule a diferença das tangentes calculadas pela função do R e
#'    pela razão acima.
...
#' 1. Crie uma lista (**não nomeada**) com dois componentes: (1) um vetor
