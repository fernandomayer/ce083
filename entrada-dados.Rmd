...
confira a estrutura dos dados com `str()`.
    a. [gam01.txt](http://www.leg.ufpr.br/~fernandomayer/dados/gam01.txt)
    b. [exemplo02.txt](http://www.leg.ufpr.br/~fernandomayer/dados/exemplo02.txt)
    c. [dadosfic.csv](http://www.leg.ufpr.br/~fernandomayer/dados/dadosfic.csv)
    d. [compingest.txt](http://www.leg.ufpr.br/~walmes/data/compingest.txt)
    e. [biomassa.txt](http://www.leg.ufpr.br/~walmes/data/biomassa.txt)
